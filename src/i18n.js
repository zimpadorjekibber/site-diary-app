...
export const translations = {
  hi: {
    ...
    manageWorkersDesc: 'यदि किसी कारीगर को गलती से गलत ट्रेड में डाल दिया है (जैसे Mason को Carpenter), तो नीचे से चुनें और "सुधारें" दबाएं:',
    btnEditWorkerSettings: '✏️ सुधारें / ट्रेड बदलें',
    manageTrades: '🏷️ कारीगर ट्रेड / श्रेणियां (Trades):',
    tradesDesc: 'आपकी साइट पर सक्रिय काम के ट्रेड:',
  ...
  en: {
    ...
    manageWorkersDesc: 'If a worker was accidentally assigned to the wrong trade, select and click "Edit":',
    btnEditWorkerSettings: '✏️ Edit / Change Trade',
